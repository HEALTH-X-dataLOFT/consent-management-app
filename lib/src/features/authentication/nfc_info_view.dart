...
import 'package:consent_management_app/src/features/authentication/nfc/widgets/id_card.dart';
import 'package:consent_management_app/src/localization/l10n.dart';
import 'package:flutter/material.dart';
import 'package:responsive_sizer/responsive_sizer.dart';

@RoutePage()
class NfcInfoView extends StatelessWidget {
  const NfcInfoView({required this.onConfirm, super.key});
              ...
              children: [
                ...
                Flexible(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      context.l10n.nfcInfoIdCardPrepare,
