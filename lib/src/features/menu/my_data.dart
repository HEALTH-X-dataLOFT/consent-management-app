                ...
                child: ListView(
                  children: [
                    AppMenuListItem(
                      onTap: () {
                        context.router.push(
                          ProviderListViewRoute(loadFilesFromProvider: true),
                        );
                      },
                      title: TextSpan(
                        text: context.l10n.menuFindingsTitle,
                        style: context.textTheme.titleMedium,
                      ),
                      subTitle: TextSpan(text: context.l10n.menuDataSubTitle),
                      graphic: const VectorGraphic(
                        loader: AssetBytesLoader(
                          'assets/images/svg/menu_medicine_pana.svg',
                        ),
                        height: 120,
                        width: 120,
                      ),
                      ...
                      AppMenuListItem(
                        onTap: () => AutoRouter.of(context).push(
                          ProviderListViewRoute(
                            loadFilesFromProvider: false,
                          ),
                        ),
                        title: TextSpan(
                          text: context.l10n.menuDownloadsTitle,
                          style: context.textTheme.titleMedium,
                        ),
                        subTitle:
                            TextSpan(text: context.l10n.menuDownloadsSubTitle),
                        graphic: const VectorGraphic(
                          loader: AssetBytesLoader(
                            'assets/images/svg/menu_download_pana.svg',
                          ),
                          height: 120,
                          width: 120,
                        ),
